...
const videosByLocation = { home: HomeVideo, about: HomeVideo, desarrollo: HomeVideo };
...
const groupVar = {
  hidden: { opacity: 0 },
  show: { opacity: 1, transition: { duration: 0.5, ease: "easeOut", staggerChildren: 0.12 } },
};
  ...
  return (
    <div className="full-container hero-contactanos bg-yellow">
      <div className="contacto-wrap">
        <motion.h1 className="contacto-title" variants={titleVar} initial="hidden" animate="show">
          Hablemos de tu proyecto
        </motion.h1>

        {revealed && (
          <motion.div className="contacto-reveal" variants={groupVar} initial="hidden" animate="show">
            <motion.p className="contacto-subtitle" variants={itemVar}>
              Contanos tus objetivos y construyamos juntos el camino más eficiente hacia resultados medibles.
            </motion.p>
            <motion.a href="#contacto" className="contacto-cta" variants={itemVar}>
