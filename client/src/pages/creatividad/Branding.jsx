    ...
    switch (activeTab) {
        ...
        return (
            ...
            <div className="container grid-tab">
                <img src={`${base}assets/creatividad/branding/busqueda.webp`} alt="Busqueda Creative" />
                <div className="text-container">
                    <h3>
                    <strong>Anuncios de búsqueda </strong> en buscadores asociados.
                </h3>
                <p>
                    Creative permite publicar los anuncios en los resultados de búsqueda y en los buscadores asociados mediante palabras claves de interés.
                </p>
                </div>
            </div>
            <div className="bento-grid">
                ...
                <div className="content-bento">
                    ...
                    <p>Creative permite publicar los anuncios en los resultados de búsqueda y en los buscadores asociados mediante palabras claves de interés.</p>
                </div>
                <div className="img-bento">
                    <img src={`${base}assets/creatividad/branding/search.webp`} alt="Search" />
                </div>
                </div>
                <div className="bento-item">
                <div className="content-bento">
                    <h3>Campañas Shopping</h3>
                    <p>Las campañas de Shopping están especialmente pensadas para promocionar productos de tiendas online.</p>
                </div>
                <div className="img-bento">
                    <img src={`${base}assets/creatividad/branding/shopping.webp`} alt="Search" />
                </div>
                </div>
                <div className="bento-item">
                <div className="content-bento">
                ...
                <div className="img-bento">
                    <img src={`${base}assets/creatividad/branding/apps.webp`} alt="Search" />
                </div>
                </div>
            </div>
            </div>
        ...
        return (
            <div className="tab-content">
            <div className="container grid-tab">
                <img src={`${base}assets/creatividad/branding/display-creative.webp`} alt="Anuncios Gráficos Creative" />
                <div className="text-container">
                <h3>
        ...
        return (
            <div className="tab-content">
            <div className="container grid-tab">
                <img src={`${base}assets/creatividad/branding/videos.webp`} alt="Anuncios Gráficos Creative" />
                <div className="text-container">
                <h3>
                ...
                <p>
                    Son campañas específicas que centran su soporte publicitario en anuncios de vídeo. Gracias este recurso se puede dar más información que en imágenes estáticas y el impacto suele ser mayor. Los anuncios se activan en la previsualización de los videos y en los sitios web de partners de vídeo.
                </p>
                </div>
            </div>
            <div className="container">
                ...
                <div className="video-slide">
                    ...
                    <div className="img-header">
                        <img src={`${base}assets/creatividad/branding/instream.webp`} alt="InStream" />
                    </div>
                    </div>
                    <div className="item-body">
                    <p>
                        Se publican durante otros videos, antes o después de ellos, o bien en sitios, juegos o aplicaciones de la Red de Display.
                    </p>
                    </div>
                </div>
                <div className="video-slide">
                    ...
                    <div className="img-header">
                        <img src={`${base}assets/creatividad/branding/instream-2.webp`} alt="InStream" />
                    </div>
                    </div>
                    <div className="item-body">
                    <p>
                ...
                <div className="video-slide">
                    ...
                    <div className="img-header">
                        <img src={`${base}assets/creatividad/branding/discovery.webp`} alt="InStream" />
                    </div>
                    </div>
                    <div className="item-body">
                    <p>
                        Solo se muestran en plataformas de video y llegan a las personas en los lugares en los que descubren contenido. Su aspecto varía según los tamaños y formatos de anuncio que admiten los publicadores de contenido.
                    </p>
                    </div>
                </div>
                <div className="video-slide">
                    ...
                    <div className="img-header">
                        <img src={`${base}assets/creatividad/branding/outstream.webp`} alt="InStream" />
                    </div>
                    </div>
                    <div className="item-body">
                    <p>
                ...
                <div className="video-slide">
                    ...
                    <div className="img-header">
                        <img src={`${base}assets/creatividad/branding/ads.webp`} alt="InStream" />
                    </div>
                    </div>
                    <div className="item-body">
                    <p>
    ...
    <>
      ...
      <div className="full-container title-container-creative">
        <div className="container title-container">
          <h3 className="display-title">[Cratividad]</h3>
        ...
        <div className="container grid-container">
          <div className="container">
            <div className="title-creative">
              <h1>Nuestro servicio de Branding está orientado al desarrollo integral de la identidad de marca.</h1>
              <div className="container">
                <p>
      ...
      <div className="full-container beneficios-container">
        <div className="container title-beneficios">
          <h1>beneficios y Rendimiento</h1>
          <h2>Nuestra metodología garantiza beneficios total:</h2>
        </div>
        <div className="container">          
