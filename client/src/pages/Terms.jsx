  ...
  return (
    <div class="full-container">
      <div class="container terms">
        ...
        <ul class="term-list">
          <li>
            <h2 class="subtitle">1. Ámbito de aplicación</h2>
            <p class="paragraph">
          ...
          <li>
            <h2 class="subtitle">2. Propiedad Intelectual</h2>
            <p class="paragraph">
          ...
          <li>
            <h2 class="subtitle">3. Alcance de los servicios</h2>
            <p class="paragraph">
          ...
          <li>
            <h2 class="subtitle">4. Revisión y cambios</h2>
            <p class="paragraph">
          ...
          <li>
            <h2 class="subtitle">6. Responsabilidad limitada</h2>
            <p class="paragraph">
          ...
          <li>
            <h2 class="subtitle">7. Propiedad y liberación de cuentas Ads</h2>
            <p class="paragraph">
          ...
          <li>
            <h2 class="subtitle">9. Jurisdicción</h2>
            <p class="paragraph">
        ...
        <p class="paragraph">
          ...
          <a href="mailto:somos@trompoagencia.com" class="link">
            somos@trompoagencia.com
          </a>
        </p>

        <h1 class="title">CLÁUSULA DE NO EXCLUSIVIDAD</h1>
        <p class="paragraph">
        ...
        <h1 class="title">CLÁUSULA DE SUSPENSIÓN</h1>
        <p class="paragraph">
