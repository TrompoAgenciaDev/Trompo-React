  ...
  React.useEffect(() => {
    ...
    const updateLineDimensions = () => {
      ...
      rafId = requestAnimationFrame(() => {
        ...
        setLineHeight(Math.max(0, nextNumberCenterY - currentNumberCenterY));
        setLineTop(currentNumberCenterY);
        rafId = null;
      });
    };
...
const ProductosItemsListSocialMedia = () => {
  ...
  return (
    <>
      {items.map((item) => (
        <EntregableItem key={item.number} number={item.number} title={item.title} itemRef={item.ref} nextItemRef={item.nextRef} isLast={item.isLast}>
          {item.children}
        </EntregableItem>
      ))}
    </>
    ...
    <>
      ...
      <div ref={animatedTextContainerRef} className="full-container white-bg">
        <div className="container animated-text-container">
          <motion.span ref={textRef} className="animated-text">
        ...
        <div className="container">
          <div className="grid-beneficios">
            <div className="grid-item-beneficios">
              ...
              <h6>Visibilidad estratégica</h6>
              <p>No es alcance sin objetivo. Es visibilidad con rumbo.</p>
            </div>
            <div className="grid-item-beneficios">
              ...
              <h6>Conversión en social</h6>
              <p>Contenidos diseñados para mover a la acción.</p>
            </div>
            <div className="grid-item-beneficios">
              ...
              <h6>Cohesión de marca</h6>
              <p>Narrativa consistente en todos los canales.</p>
            </div>
            <div className="grid-item-beneficios">
              ...
              <h6>Decisión basada en datos</h6>
              <p>Reportes orientados a acción y evolución.</p>
            </div>
          </div>
        </div>
      </div>
