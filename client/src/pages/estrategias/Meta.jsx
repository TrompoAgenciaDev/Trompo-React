...
//styles
import "@as/hero.css";
import "../../assets/styles/meta-ads.css";
    ...
    switch (activeTab) {
          ...
          <div className="tab-content">
            <div className="container grid-tab">
              ...
              <div className="text-container">
                ...
                <p>
                  Meta Ads permite publicar los anuncios en los resultados de búsqueda de Meta y en los buscadores asociados (Aol, Terra, Maps, YouTube, etc) mediante palabras claves de interés.
                </p>
              </div>
            </div>
            <div className="bento-grid">
              <div className="bento-item">
                <div className="content-bento">
                  ...
                  <p>Meta Ads permite publicar los anuncios en los resultados de búsqueda de Meta y en los buscadores asociados (Aol, Terra, Maps, YouTube,etc) mediante palabras claves de interés.</p>
                </div>
                <div className="img-bento">
                  <img src={`${base}assets/estrategia/meta-ads/search.png`} alt="Search" />
                </div>
              </div>
              <div className="bento-item">
                <div className="content-bento">
                  <h3>Campañas Shopping</h3>
                  <p>Las campañas de Meta Shopping están especialmente pensadas para promocionar productos de tiendas online.</p>
                </div>
                <div className="img-bento">
                  <img src={`${base}assets/estrategia/meta-ads/shopping.png`} alt="Search" />
                </div>
              </div>
              <div className="bento-item">
                <div className="content-bento">
                ...
                <div className="img-bento">
                  <img src={`${base}assets/estrategia/meta-ads/apps.png`} alt="Search" />
                </div>
              </div>
            </div>
          </div>
      ...
      case "graficos":
        return (
          <div className="tab-content">
            <div className="container grid-tab">
              <img src={`${base}assets/estrategia/meta-ads/display-meta-ads.png`} alt="Anuncios Gráficos Meta Ads" />
              <div className="text-container">
                <h3>
      ...
      case "video":
        return (
          <div className="tab-content">
            <div className="container grid-tab">
              <img src={`${base}assets/estrategia/meta-ads/videos.png`} alt="Anuncios Gráficos Meta Ads" />
              <div className="text-container">
                <h3>
              ...
              >
                <div className="video-slide">
                  <div className="item-header">
                    ...
                    <div className="img-header">
                      <img src={`${base}assets/estrategia/meta-ads/instream.png`} alt="InStream" />
                    </div>
                  </div>
                  <div className="item-body">
                    <p>
                ...
                <div className="video-slide">
                  <div className="item-header">
                    ...
                    <div className="img-header">
                      <img src={`${base}assets/estrategia/meta-ads/instream-2.png`} alt="InStream" />
                    </div>
                  </div>
                  <div className="item-body">
                    <p>
                ...
                <div className="video-slide">
                  <div className="item-header">
                    ...
                    <div className="img-header">
                      <img src={`${base}assets/estrategia/meta-ads/discovery.png`} alt="InStream" />
                    </div>
                  </div>
                  <div className="item-body">
                    <p>
                ...
                <div className="video-slide">
                  <div className="item-header">
                    ...
                    <div className="img-header">
                      <img src={`${base}assets/estrategia/meta-ads/outstream.png`} alt="InStream" />
                    </div>
                  </div>
                  <div className="item-body">
                    <p>
                ...
                <div className="video-slide">
                  <div className="item-header">
                    ...
                    <div className="img-header">
                      <img src={`${base}assets/estrategia/meta-ads/ads.png`} alt="InStream" />
                    </div>
                  </div>
                  <div className="item-body">
                    <p>
