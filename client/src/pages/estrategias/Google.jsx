    ...
    switch (activeTab) {
        ...
        return (
          <div className="tab-content">
            <div className="container grid-tab">
              <img src={`${base}assets/estrategia/google-ads/busqueda.png`} alt="Busqueda Google Ads" />
            ...
            <div className="bento-grid">
              <div className="bento-item">
                ...
                <div className="img-bento">
                  <img src={`${base}assets/estrategia/google-ads/search.png`} alt="Search" />
                </div>
              </div>
              <div className="bento-item">
                <div className="content-bento">
                ...
                <div className="img-bento">
                  <img src={`${base}assets/estrategia/google-ads/shopping.png`} alt="Search" />
                </div>
              </div>
              <div className="bento-item">
                <div className="content-bento">
                ...
                <div className="img-bento">
                  <img src={`${base}assets/estrategia/google-ads/apps.png`} alt="Search" />
                </div>
              </div>
            </div>
          </div>
      ...
      case "video":
        return (
          <div className="tab-content">
            <div className="container grid-tab">
              <img src={`${base}assets/estrategia/google-ads/videos.png`} alt="Anuncios Gráficos Google Ads" />
              <div className="text-container">
                <h3>
              ...
              >
                <div className="video-slide">
                  <div className="item-header">
                    ...
                    <div className="img-header">
                      <img src={`${base}assets/estrategia/google-ads/instream.png`} alt="InStream" />
                    </div>
                  </div>
                  <div className="item-body">
                    <p>
                ...
                <div className="video-slide">
                  <div className="item-header">
                    ...
                    <div className="img-header">
                      <img src={`${base}assets/estrategia/google-ads/instream-2.png`} alt="InStream" />
                    </div>
                  </div>
                  <div className="item-body">
                    <p>
                ...
                <div className="video-slide">
                  <div className="item-header">
                    ...
                    <div className="img-header">
                      <img src={`${base}assets/estrategia/google-ads/discovery.png`} alt="InStream" />
                    </div>
                  </div>
                  <div className="item-body">
                    <p>
                ...
                <div className="video-slide">
                  <div className="item-header">
                    ...
                    <div className="img-header">
                      <img src={`${base}assets/estrategia/google-ads/outstream.png`} alt="InStream" />
                    </div>
                  </div>
                  <div className="item-body">
                    <p>
                ...
                <div className="video-slide">
                  <div className="item-header">
                    ...
                    <div className="img-header">
                      <img src={`${base}assets/estrategia/google-ads/ads.png`} alt="InStream" />
                    </div>
                  </div>
                  <div className="item-body">
                    <p>
