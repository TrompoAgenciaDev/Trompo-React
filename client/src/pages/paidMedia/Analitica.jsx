...
const Analitica = () => {
  ...
  return (
    <>
      ...
      <div className="full-container indicadores diagonal-inverdtida-ads bg-yellow-2">
        <div className="container">
          <div className="grid-title-indicadores">
            <div className="tabs-container">
              <div className="tab-button">Indicadores Clave (KPI)</div>
              <div className="tab-button">Estructura del sitio y procesos</div>
              <div className="tab-button">Seguimiento en tiempo real</div>
            </div>
          </div>
        </div>
        <div className="container">
          <div className="grid-container-indicadores">
            <div className="grid-item-indicadores">
              <h3>Medimos los datos que importan para cada tipo de proyecto:</h3>
            </div>
            <div className="grid-item-indicadores">
              <ul>
                <li>
                ...
                <li>
                  Canales de adquisición (orgánico, social, pago, referido)
                </li>
                <li>
                  Páginas más visitadas
                </li>
                <li>
                  Scroll depth / tiempo promedio por página
                </li>
                <li>
            ...
            <div className="grid-item-indicadores">
              <ul>
                ...
                <li>
                  Conversiones por canal / fuente
                </li>
                <li>
                  Embudos de conversión
                </li>
                <li>
                  Costo por adquisición (CPA) y retorno (ROAS)
                </li>
              </ul>
            </div>
          </div>
