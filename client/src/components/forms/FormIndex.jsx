  ...
  return (
    <div className="sib-form">
      <form id="sib-form" onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          <label htmlFor="EMAIL">Ingresá tu Email corporativo*</label>
          <input
            id="EMAIL"
            type="email"
            name="EMAIL"
        ...
        <div className="form-group">
          <label htmlFor="SMS">Ingresá tu teléfono*</label>
          <div className="sms-section">
            <select name="SMS_COUNTRY_CODE" defaultValue="+54" required>
